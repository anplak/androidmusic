...
class PlayHistoryDaoTest {
    ...
    @Test
    fun `insert creates new history entry and returns id`() =
        runTest {
    ...
    @Test
    fun `insert with sessionId stores session`() =
        runTest {
            trackDao.insert(createTrackEntity(1))
    ...
    @Test
    fun `update modifies existing entry`() =
        runTest {
            trackDao.insert(createTrackEntity(1))
            val historyId =
                playHistoryDao.insert(
    ...
    @Test
    fun `getHistory returns entries in reverse chronological order`() =
        runTest {
            trackDao.insert(createTrackEntity(1))
    ...
    @Test
    fun `getHistory respects limit and offset`() =
        runTest {
            trackDao.insert(createTrackEntity(1))
    ...
    @Test
    fun `getHistory includes track details`() =
        runTest {
            trackDao.insert(
                TrackEntity(
                    id = 1,
    ...
    @Test
    fun `getHistoryForTrack returns only entries for specified track`() =
        runTest {
            trackDao.insert(createTrackEntity(1))
            trackDao.insert(createTrackEntity(2))
    ...
    @Test
    fun `getHistorySince returns entries after timestamp`() =
        runTest {
            trackDao.insert(createTrackEntity(1))
    ...
    @Test
    fun `getTotalPlayTimeSince calculates sum of durations`() =
        runTest {
            trackDao.insert(createTrackEntity(1))
    ...
    @Test
    fun `getTotalPlayTimeSince returns 0 when no entries`() =
        runTest {
    ...
    @Test
    fun `getTopTracksSince returns tracks ordered by play count`() =
        runTest {
            trackDao.insert(createTrackEntity(1))
            trackDao.insert(createTrackEntity(2))
    ...
    @Test
    fun `getTopTracksSince respects limit`() =
        runTest {
            trackDao.insert(createTrackEntity(1))
            trackDao.insert(createTrackEntity(2))
            trackDao.insert(createTrackEntity(3))
    ...
    @Test
    fun `getTopArtistsSince returns artists ordered by play count`() =
        runTest {
    ...
    @Test
    fun `getHistoryCount returns correct count`() =
        runTest {
            trackDao.insert(createTrackEntity(1))
    ...
    @Test
    fun `deleteHistoryOlderThan removes old entries`() =
        runTest {
            trackDao.insert(createTrackEntity(1))
    ...
    @Test
    fun `deleting track cascades to history`() =
        runTest {
            trackDao.insert(createTrackEntity(1))
            playHistoryDao.insert(PlayHistoryEntity(trackId = 1, playedAt = 1000L))
