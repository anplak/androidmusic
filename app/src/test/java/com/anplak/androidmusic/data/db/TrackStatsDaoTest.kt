...
class TrackStatsDaoTest {
    ...
    @Test
    fun `insertIfNotExists creates new stats entry`() =
        runTest {
    ...
    @Test
    fun `insertIfNotExists does not overwrite existing stats`() =
        runTest {
            trackDao.insert(createTrackEntity(1))
            trackStatsDao.insertIfNotExists(TrackStatsEntity(trackId = 1))
    ...
    @Test
    fun `incrementPlayCount updates count and timestamp`() =
        runTest {
            trackDao.insert(createTrackEntity(1))
            trackStatsDao.insertIfNotExists(TrackStatsEntity(trackId = 1))
    ...
    @Test
    fun `incrementCompletionCount updates completion count`() =
        runTest {
            trackDao.insert(createTrackEntity(1))
            trackStatsDao.insertIfNotExists(TrackStatsEntity(trackId = 1))
    ...
    @Test
    fun `getMostPlayedTrackIds returns ordered by playCount desc`() =
        runTest {
            // Setup tracks
            trackDao.insert(createTrackEntity(1))
    ...
    @Test
    fun `getMostPlayedTrackIds respects limit`() =
        runTest {
            trackDao.insert(createTrackEntity(1))
            trackDao.insert(createTrackEntity(2))
            trackDao.insert(createTrackEntity(3))
    ...
    @Test
    fun `getMostPlayedTrackIds excludes tracks with zero plays`() =
        runTest {
            trackDao.insert(createTrackEntity(1))
            trackDao.insert(createTrackEntity(2))
    ...
    @Test
    fun `getRecentlyPlayedTrackIds returns ordered by lastPlayedAt desc`() =
        runTest {
            trackDao.insert(createTrackEntity(1))
            trackDao.insert(createTrackEntity(2))
            trackDao.insert(createTrackEntity(3))
    ...
    @Test
    fun `getRecentlyPlayedTrackIds excludes tracks never played`() =
        runTest {
            trackDao.insert(createTrackEntity(1))
            trackDao.insert(createTrackEntity(2))
    ...
    @Test
    fun `incrementSkipCount increases skip count`() =
        runTest {
            trackDao.insert(createTrackEntity(1))
            trackStatsDao.insertIfNotExists(TrackStatsEntity(trackId = 1))
    ...
    @Test
    fun `deleting track cascades to stats`() =
        runTest {
            trackDao.insert(createTrackEntity(1))
            trackStatsDao.insertIfNotExists(TrackStatsEntity(trackId = 1))
            trackStatsDao.incrementPlayCount(1)
